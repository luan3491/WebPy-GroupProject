...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        game_names = [
            'Astral Drift', 'Neon Frontier', 'Shadow Vault', 'Crystal Rune', 'Midnight Circuit',
            'Pixel Harbor', 'Stormborn Legends', 'Echoes of Ember', 'Frostbite Arena', 'Solaris Quest',
            'Arcade Dynasty', 'Iron Harbor', 'Velvet Mechanics', 'Cobalt Frontier', 'Moonlit Heist',
            'Raven Protocol', 'Titanic Echo', 'Wanderlight', 'Ghost Relay', 'Lunar Breakers',
            'Nova Tactics', 'Chrono Forge', 'Deepwater Odyssey', 'Radiant Clash', 'Velocirunner',
            'Silent Meridian', 'Dragon Keep', 'Skyline Overdrive', 'Aurora Protocol', 'Evergreen Wars',
        ]
        ...
        for index, name in enumerate(game_names, start=1):
            ...
            game = Game.objects.create(
                ...
                operation_system=operation_systems[(index - 1) % len(operation_systems)],
            )
            if created_users:
